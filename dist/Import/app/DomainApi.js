...
var DomainApi = function (_Chain) {
    ...
    function DomainApi() {
        ...
        var _this = _possibleConstructorReturn(this, (DomainApi.__proto__ || Object.getPrototypeOf(DomainApi)).call(this, 'ImportDomainApi', function (context, param, next) {
            var dto = param.dto ? param.dto() : new _gdsConfig.GDSDomainDTO();
            dto.addPost('createImportCSV', param.protocol() + param.host() + _ImportResource.API + 'create-import-csv');
            context.set('dto', dto);
            next();
        }));
